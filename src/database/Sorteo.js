const agregarSorteo = (data, callback) =>{

}

const obtenerParticipantes = (data, callback)=>{
    const query = `SELECT 
...
module.exports = {agregarSorteo, obtenerParticipantes, determinarGanador, obtenerSorteo}